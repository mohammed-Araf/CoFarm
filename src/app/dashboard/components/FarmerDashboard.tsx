...
export default function FarmerDashboard({
      ...
      try {
        ...
        const response = await fetch('/api/farmer-advice', {
          ...
          body: JSON.stringify({
            ...
            criticalAlertDetails: criticalAlerts.map(a => a.message),
  ...
  }, [ownNodes.length, alerts.length, criticalAlerts.length, sensorReading?.air_temperature_c, sensorReading?.soil_moisture_m3m3]);
      ...
      <div className="max-w-4xl mx-auto w-full space-y-8">
        ...
        <div className={`p-8 rounded-2xl border ${bgColor} flex flex-col items-center justify-center text-center transition-colors duration-500`}>
          ...
          <p className="text-gray-300 text-lg">
            ...
            {criticalAlerts.length > 0 && ` There are ${criticalAlerts.length} critical issues that need you right away!`}
          </p>
        </div>
